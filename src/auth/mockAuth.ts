...
export type { StuartAccountStatus, StuartMfaStatus, StuartRole, StuartSessionType, StuartUser }

/** @deprecated Use SessionDisplay from services/auth — kept for catalog compatibility. */
